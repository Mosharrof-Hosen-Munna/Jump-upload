...
const Form = () => {
  const [selectedPromt, setSelectedPromt] = useState({});
  ...
  const formSubmit = (e) => {
    ...
    formData.append('promt', JSON.stringify(selectedPromt));
    const config = {
      headers: {
    ...
    <div className="container mx-auto my-10 flex">
      <div className="w-1/2  p-10 shadow-md backgroundSecondary">
        <form className=" mx-auto" onSubmit={formSubmit}>
          ...
          {/* suggest field */}
          <Promts setSelectedPromt ={setSelectedPromt}  selectedPromt={selectedPromt}/>
